...
loadAndPlaceOBJ('gltf/vendor/vendor.obj', envmapMaterial, function (vendor) {
  vendor.position.set(0.0, 3.0, 6.0);
  vendor.rotation.set(0, 90, 0);
  vendor.scale.set(3.0, 3.0, 3.0);
  vendor.parent = worldFrame;
  scene.add(vendor);
});

// Armadillo Shadow
loadAndPlaceOBJ('gltf/vendor/vendor.obj', shadowMaterial, function (vendor) {
  vendor.position.set(0.0, 3.0, 6.0);
  vendor.rotation.set(0, 90, 0);
  vendor.scale.set(3.0, 3.0, 3.0);
  vendor.parent = worldFrame;
  shadowScene.add(vendor);
});
